...
HD_PWD='X:/timar/413lab6X/413lab6X.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pipeliner.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pipeliner.tcl

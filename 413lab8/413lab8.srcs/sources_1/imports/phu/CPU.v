...
hazardunit 	  HazardDetectionUnit(IFID_Enable,PCWrite,HazardMuxSelect, RegDestMuxOut, MemDest, ReadReg1, ReadReg2, AluSrc, PCSelect[1], PCSelect[0], EXMEM_WBControl, WB_WBControl);
